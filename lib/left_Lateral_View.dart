...
class LeftLateralViewScreen extends StatefulWidget {
  final String doctorName;
  final Map<String, dynamic> patientData;
  final String patientId;
  LeftLateralViewScreen(
      {Key? key,
  ...
  @override
  _LeftLateralViewState createState() => _LeftLateralViewState();
}
...
class _LeftLateralViewState extends State<LeftLateralViewScreen> {
  ...
  Future<void> runObjectDetection(image, path) async {
    ...
    var pictureUrl = await Future.wait([
      uploadFileForUsers(File(image!.path), "$path-leftLateralView",
          "$path-leftLateralView-$uniqueNum", rects, true)
    ]);

    Future.wait([
      uploadFileForUsers(File(txtPath), "$path-leftLateralView",
          "$path-leftLateralView-$uniqueNum", rects, false)
    ]);
...
// Function to reset teeth selections on this screen
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image(
                                        ...
                                        width: 25.0,
                                        height: 25.0, // Adjusted image size
                                      ),
                                      Text(
                                        '${teeth[j][i]}',
                                        textAlign: TextAlign.center,
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    set_view_status("LeftLateralView");
